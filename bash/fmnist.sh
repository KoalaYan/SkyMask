...
python main.py --aggregation ${aggregation[agr_i]} --net cnn --dataset FashionMNIST --niter 20 --global_lr 0.5 --local_lr 0.5 --local_iter 1 --batch_size 32 --nworkers 100 --nbyz 20 --bias 0.1 --byz_type ${attack[atk_i]} &
done
wait
done